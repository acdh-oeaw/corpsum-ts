...
type SearchFunctionKey = "keywordInContext" | "regionalFrequencies" | "wordFormFrequencies" | "yearlyFrequencies";
...
export const useSearchSettingsStore = defineStore('searchSettings', () => {
	...
	const selectedSearches = ref(["keywordInContext", "regionalFrequencies", "wordFormFrequencies", "yearlyFrequencies"]);
