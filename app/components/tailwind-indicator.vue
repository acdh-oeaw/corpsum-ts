...
<template>
	<div
		v-if="isVisible"
		class="fixed bottom-4 right-4 z-10 grid size-8 place-content-center rounded-full bg-foreground font-mono text-xs font-medium text-background"
	>
		...
		<span class="3xl:hidden max-2xl:hidden">2xl</span>
